...
public class User {
    /**
     *Contains a User email and User Password.the class is suitable for Hibernate usage.
     * all members are private hence we use setters and getters
     */
    ...
    public String getEmail() {
        /**
         * returns the user email as a String Object. cant be Null
         */
        return email;
    }
